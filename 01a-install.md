...
>> Python 3. Might as well onboard directly to the latest version. I'll figure out the differences from 2 to 3, with the state of legacy code still out there.
